...
library(openxlsx)
#input data#
femData <- read_csv("human_data.csv")
...
#save#
save(datExpr, datTraits, file = "WGCNAdataInput.RData")
###WGCNA###
options(stringsAsFactors = FALSE);
lnames = load(file = "WGCNAdataInput.RData");
lnames
#chose powers#
powers = c(seq(1, 15, by = 1)) 
...
modules_of_interest <- c("turquoise", "black", "purple")
...
cat("percentage of CCN regulatory‑network genes remain preserved within their original module eigengenes (MEs)", 
    round(stable_ratio * 100, 1), "%\n")